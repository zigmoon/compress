...
{
	_e('<div class="notice notice-error ishf-error-msg is-dismissible"><p>' . $msg . '</p></div>','compress-analytics');	
}
function ishf_success_option_msg($msg)
{
	_e('<div class="notice notice-success ishf-success-msg is-dismissible"><p>'. $msg . '</p></div>','compress-analytics');
}
